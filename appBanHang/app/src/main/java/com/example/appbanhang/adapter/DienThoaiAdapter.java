...
public class DienThoaiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            try {
                ...
                if (giasp != null) {
                    ...
                    if (giasp instanceof Number) {
                        myViewHolder.giasp.setText("Giá: " + decimalFormat.format(giasp) + "đ");
                    } else {
                        // Nếu là String, thử chuyển đổi sang số
                        myViewHolder.giasp.setText("Giá: " + decimalFormat.format(Double.parseDouble(giasp.toString())) + "đ");
                    }
                } else {
                    // Xử lý khi giá là null
                    myViewHolder.giasp.setText("Giá: Liên hệ");
                }
            } catch (Exception e) {
    ...
    public void notifyItemInserted(int vitri, int soluongadd) {
    }
